...
| 任务 | 等什么 | 会话要求 |
|---|---|---|
| TD-03-T4(审批 suspend/resume + clarification_required) | 🔵 **疑似进行中**（主仓库 worktree 有未提交的 `approval_bridge.py`）；前置 TD-03-T3✅ | **agentpulse** |
| [TD-06-T2](TD-06-agent-self-evolution.md)(主动能力升级申请) | TD-03-T4；前置 TD-04-T6✅ + `approvals.type=capability_upgrade` 已在 schema✅ | **agentpulse** |
